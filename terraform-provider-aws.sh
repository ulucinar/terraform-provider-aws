...
LOG_DIR=/Users/alper/data/workspaces/xp/fix-ezgis/logged-tests-8
...
#"$(dirname "${TERRAFORM_NATIVE_PROVIDER_PATH}")/terraform-provider-aws" | tee -a ${LOG_DIR}/native-provider-stdout.log
